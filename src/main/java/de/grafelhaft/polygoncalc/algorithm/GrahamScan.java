...
public class GrahamScan {
     ...
     */
    protected static List<? extends IPoint> getConvexHull(int[] xs, int[] ys) throws IllegalArgumentException {
     ...
     * <code>List&lt;java.awt.Point&gt;</code> are the same point.
     *
     * @param points the x and y coordinates.
     * @return   the convex hull of the points created from <code>xs</code>
     *           and <code>ys</code>.
     * @throws IllegalArgumentException if <code>xs</code> and <code>ys</code>
     *                                  don't have the same size, if all points
     ...
     *                                  3 unique points present.
     */
    protected static IPoint[] getConvexHull(IPoint[] points) throws IllegalArgumentException {
     ...
     */
    protected static List<? extends IPoint> getConvexHull(List<? extends IPoint> points) throws IllegalArgumentException {
